...
class SearchAndDploy:
    def __init__(self, faiss_index_path, qdrant_url, embedding_model, llm_model):
        # Initialize embedding model
        self.embeddings = OllamaEmbeddings(model=embedding_model, base_url = 'http://ollama:11434')
    ...
    def search_and_rerank(self, query, k=50, top_n=3):
        ...
        # Make sure to use the correct collection name that already exists
    ...
    def search_and_display_results(self, query):
        ...
        try:
            ...
            output_prompt = f"""
            Present the following top 3 search results in a clean and readable format. 
            ...
            **Text:** Full text.
            ...
            Ensure that the author's name is hyperlinked to the corresponding URL, and that the date is formatted properly.
...
search_and_display = SearchAndDploy(
    faiss_index_path='/app/faiss_index.index',
    qdrant_url='http://qdrant:6333',  # Updated URL
...
iface = gr.Interface(
    ...
    inputs="text",
    outputs="markdown",
    title="Mana Saleh | Hugging Face Search Engine",
    description="Enter a search query and retrieve the top 3 results, formatted by LLaMA3."
)

if __name__ == "__main__":
    iface.launch(server_name="0.0.0.0", server_port=int(os.getenv("GRADIO_SERVER_PORT", 8080)), share=True)
